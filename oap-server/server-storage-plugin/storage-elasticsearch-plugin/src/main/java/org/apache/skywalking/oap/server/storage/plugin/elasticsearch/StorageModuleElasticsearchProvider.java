...
public class StorageModuleElasticsearchProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IProjectInventoryCacheDAO.class, new ProjectInventoryCacheEsDAO(elasticSearchClient));
        ...
        this.registerServiceImplementation(IServiceDotsQueryDAO.class, new ServiceDotsQueryESDAO(elasticSearchClient));
    }
